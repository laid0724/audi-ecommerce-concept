...
namespace server.Data.Migrations
{
    ...
    [Migration("20210909110918_ChangeOrderForeignKeyToEmailAsPrincipalKey")]
    partial class ChangeOrderForeignKeyToEmailAsPrincipalKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Audi.Entities.AppUserProduct", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");
                    ...
                    b.HasKey("UserId", "ProductId")
                        .HasName("pk_app_user_products");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_app_user_products_product_id");

                    b.ToTable("app_user_products");
                });
